...
public class TestADExternalImage {
    ...
    public void checkAbilityToCreateAd() throws IOException, InterruptedException {
        ...
        if (settingModule.isDisplayed()){
            reportCreator.write("External AD entity is successfully created", configs.FileReportLocation, configs.FileReporName);
        }
        else{
            reportCreator.write("External AD entity is unsuccessfully created", configs.FileReportLocation, configs.FileReporName);
        }
